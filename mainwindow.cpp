...
//! [0]
    ...
    DealWithDataThread *thread=new DealWithDataThread(this);
...
//! [2]
    ...
    connect(this,SIGNAL(DataReceived(QByteArray)),thread,SLOT(ReceiveDataSlot(QByteArray)));

    connect(thread,SIGNAL(TestDataBack(int)),this,SLOT(TestDataReceiver(int)));
    connect(thread,SIGNAL(AfterDealWithError(QByteArray)),this,SLOT(AfterDealReceiver(QByteArray)));
    connect(thread,SIGNAL(sendRequest(QString,QString)),this,SLOT(receiveReqeust(QString,QString)));
